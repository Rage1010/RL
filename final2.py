...
lamda = 0.97
epsilon = 0.15
with open('action_value2.pkl', 'rb') as file:
    action_value = pickle.load(file)
with open('number_times2.pkl', 'rb') as file:
    number_times = pickle.load(file)
r = []
...
print(np.mean(r))
with open('action_value2.pkl', 'wb') as file:
    pickle.dump(action_value, file)

with open('number_times2.pkl', 'wb') as file:
